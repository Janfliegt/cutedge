...
function [] = local_loss_parameter_modified(processed_data_dir, validate_width, frequency_max,cur_dir)
...
save_dir =fullfile(processed_data_dir, 'local_loss_parameters');
...
for index_frequency = 1 : number_frequency
    ...
    range = [[3 2 1 2];[0 0 0 0]];         % a1 ~ [1 1+3], depta_a1,  ,alpha~[0,1]
    % initiation
...
save_matfile_allfrequency =  fulllfile(save_dir,'hyst', 'allfrequency.mat');    
...
save_allfrequency = [save_dir,'\','hyst'];
save_alpha_x_frequency = [save_allfrequency, '\', 'alpha_x_frequency']; 
