function [] = optimierung_main_find_Fb_corrected_data_for_all_frequency(used_frequency, cur_dir, processed_data_dir)
%% setups 
addpath(genpath(cur_dir))
% width_except = ;
search_min = 0.6;
search_max = 1;
threshold_F_0 = 0.2; % a threshold for F_0, which should equal 1 
%%
...
% remove the unsed frequency data 
