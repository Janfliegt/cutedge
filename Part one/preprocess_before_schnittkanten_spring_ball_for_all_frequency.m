function [] = preprocess_before_schnittkanten_spring_ball_for_all_frequency(original_data_dir, cur_dir)

% preprocessing of measurement data
eval(['cd ' original_data_dir])
allfrequency_data = fullfile(original_data_dir, 'plot_original_data', 'allfrequency.mat');
load(allfrequency_data)
C = who; 
struct_name= C{:}; 
save_dir = 'plot_corrected_data';
